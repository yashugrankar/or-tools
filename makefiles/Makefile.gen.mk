...
$(OBJ_DIR)/base/file.$O: \
    ...
    $(SRC_DIR)/ortools/base/file.h \
    $(SRC_DIR)/ortools/base/join.h \
    $(SRC_DIR)/ortools/base/logging.h | $(OBJ_DIR)/base
...
$(OBJ_DIR)/port/file_nonport.$O: \
    ...
    $(SRC_DIR)/ortools/base/file.h \
    $(SRC_DIR)/ortools/port/file.h | $(OBJ_DIR)/port
...
$(OBJ_DIR)/port/sysinfo_nonport.$O: \
    ...
    $(SRC_DIR)/ortools/base/sysinfo.h \
    $(SRC_DIR)/ortools/port/sysinfo.h | $(OBJ_DIR)/port
...
$(OBJ_DIR)/util/graph_export.$O: \
    ...
    $(SRC_DIR)/ortools/base/status.h \
    $(SRC_DIR)/ortools/base/stringprintf.h \
    $(SRC_DIR)/ortools/util/graph_export.h | $(OBJ_DIR)/util
...
$(OBJ_DIR)/util/piecewise_linear_function.$O: \
    ...
    $(SRC_DIR)/ortools/base/logging.h \
    $(SRC_DIR)/ortools/base/stringprintf.h \
    $(SRC_DIR)/ortools/util/piecewise_linear_function.h | $(OBJ_DIR)/util
...
$(OBJ_DIR)/util/proto_tools.$O: \
    ...
    $(SRC_DIR)/ortools/base/join.h \
    $(SRC_DIR)/ortools/util/proto_tools.h | $(OBJ_DIR)/util
...
$(OBJ_DIR)/util/range_query_function.$O: \
    ...
    $(SRC_DIR)/ortools/base/macros.h \
    $(SRC_DIR)/ortools/util/range_minimum_query.h \
    $(SRC_DIR)/ortools/util/range_query_function.h | $(OBJ_DIR)/util
...
$(OBJ_DIR)/util/rational_approximation.$O: \
    ...
    $(SRC_DIR)/ortools/base/logging.h \
    $(SRC_DIR)/ortools/util/rational_approximation.h | $(OBJ_DIR)/util
...
$(OBJ_DIR)/util/sigint.$O: \
    ...
    $(SRC_DIR)/ortools/base/logging.h \
    $(SRC_DIR)/ortools/util/sigint.h | $(OBJ_DIR)/util
...
$(OBJ_DIR)/util/sorted_interval_list.$O: \
    ...
    $(SRC_DIR)/ortools/base/stringprintf.h \
    $(SRC_DIR)/ortools/util/saturated_arithmetic.h \
    $(SRC_DIR)/ortools/util/sorted_interval_list.h | $(OBJ_DIR)/util
...
$(OBJ_DIR)/util/xml_helper.$O: \
    ...
    $(SRC_DIR)/ortools/base/stringprintf.h \
    $(SRC_DIR)/ortools/base/strutil.h \
    $(SRC_DIR)/ortools/util/xml_helper.h | $(OBJ_DIR)/util
...
$(GEN_DIR)/ortools/util/optional_boolean.pb.cc: \
	...
	$(PROTOC) --proto_path=$(INC_DIR) $(PROTOBUF_PROTOC_INC) --cpp_out=$(GEN_DIR) $(SRC_DIR)/ortools/util/optional_boolean.proto

$(GEN_DIR)/ortools/util/optional_boolean.pb.h: $(GEN_DIR)/ortools/util/optional_boolean.pb.cc \

$(OBJ_DIR)/util/optional_boolean.pb.$O:	$(GEN_DIR)/ortools/util/optional_boolean.pb.cc | $(OBJ_DIR)/util
...
$(OBJ_DIR)/data/jobshop_scheduling_parser.$O: \
    ...
    $(SRC_DIR)/ortools/base/strtoint.h \
    $(SRC_DIR)/ortools/data/jobshop_scheduling_parser.h \
    $(GEN_DIR)/ortools/data/jobshop_scheduling.pb.h | $(OBJ_DIR)/data
...
$(OBJ_DIR)/data/rcpsp_parser.$O: \
    ...
    $(SRC_DIR)/ortools/base/strtoint.h \
    $(SRC_DIR)/ortools/data/rcpsp_parser.h \
    $(GEN_DIR)/ortools/data/rcpsp.pb.h | $(OBJ_DIR)/data
...
$(OBJ_DIR)/data/set_covering_data.$O: \
    ...
    $(SRC_DIR)/ortools/data/set_covering_data.h | $(OBJ_DIR)/data
...
$(OBJ_DIR)/data/set_covering_parser.$O: \
    ...
    $(SRC_DIR)/ortools/base/split.h \
    $(SRC_DIR)/ortools/base/strtoint.h \
    $(SRC_DIR)/ortools/data/set_covering_parser.h | $(OBJ_DIR)/data
...
$(GEN_DIR)/ortools/data/jobshop_scheduling.pb.cc: \
	...
	$(PROTOC) --proto_path=$(INC_DIR) $(PROTOBUF_PROTOC_INC) --cpp_out=$(GEN_DIR) $(SRC_DIR)/ortools/data/jobshop_scheduling.proto

$(GEN_DIR)/ortools/data/jobshop_scheduling.pb.h: $(GEN_DIR)/ortools/data/jobshop_scheduling.pb.cc \

$(OBJ_DIR)/data/jobshop_scheduling.pb.$O:	$(GEN_DIR)/ortools/data/jobshop_scheduling.pb.cc | $(OBJ_DIR)/data
...
$(GEN_DIR)/ortools/data/rcpsp.pb.cc: \
	...
	$(PROTOC) --proto_path=$(INC_DIR) $(PROTOBUF_PROTOC_INC) --cpp_out=$(GEN_DIR) $(SRC_DIR)/ortools/data/rcpsp.proto

$(GEN_DIR)/ortools/data/rcpsp.pb.h: $(GEN_DIR)/ortools/data/rcpsp.pb.cc \

$(OBJ_DIR)/data/rcpsp.pb.$O:	$(GEN_DIR)/ortools/data/rcpsp.pb.cc | $(OBJ_DIR)/data
	$(CCC) $(CFLAGS) -c $(GEN_DIR)/ortools/data/rcpsp.pb.cc $(OBJ_OUT)$(OBJ_DIR)$Sdata$Srcpsp.pb.$O
...
$(OBJ_DIR)/lp_data/lp_data.$O: \
    ...
    $(SRC_DIR)/ortools/lp_data/lp_utils.h \
    $(SRC_DIR)/ortools/lp_data/matrix_utils.h \
    $(SRC_DIR)/ortools/lp_data/permutation.h | $(OBJ_DIR)/lp_data
...
$(OBJ_DIR)/lp_data/lp_data_utils.$O: \
    ...
    $(SRC_DIR)/ortools/lp_data/lp_data_utils.h | $(OBJ_DIR)/lp_data
...
$(OBJ_DIR)/lp_data/lp_decomposer.$O: \
    ...
    $(SRC_DIR)/ortools/lp_data/lp_data.h \
    $(SRC_DIR)/ortools/lp_data/lp_decomposer.h \
    $(SRC_DIR)/ortools/lp_data/lp_utils.h | $(OBJ_DIR)/lp_data
...
$(OBJ_DIR)/lp_data/lp_print_utils.$O: \
    ...
    $(SRC_DIR)/ortools/lp_data/lp_print_utils.h \
    $(SRC_DIR)/ortools/lp_data/lp_types.h \
    $(SRC_DIR)/ortools/util/rational_approximation.h | $(OBJ_DIR)/lp_data
...
$(OBJ_DIR)/lp_data/lp_types.$O: \
    ...
    $(SRC_DIR)/ortools/lp_data/lp_types.h | $(OBJ_DIR)/lp_data
...
$(OBJ_DIR)/lp_data/matrix_scaler.$O: \
    ...
    $(SRC_DIR)/ortools/lp_data/matrix_scaler.h \
    $(SRC_DIR)/ortools/lp_data/sparse.h \
    $(SRC_DIR)/ortools/util/time_limit.h | $(OBJ_DIR)/lp_data
...
$(OBJ_DIR)/lp_data/matrix_utils.$O: \
    ...
    $(SRC_DIR)/ortools/base/hash.h \
    $(SRC_DIR)/ortools/lp_data/matrix_utils.h | $(OBJ_DIR)/lp_data
...
$(OBJ_DIR)/lp_data/model_reader.$O: \
    ...
    $(SRC_DIR)/ortools/lp_data/mps_reader.h \
    $(SRC_DIR)/ortools/lp_data/proto_utils.h \
    $(SRC_DIR)/ortools/util/file_util.h | $(OBJ_DIR)/lp_data
...
$(OBJ_DIR)/lp_data/mps_reader.$O: \
    ...
    $(SRC_DIR)/ortools/base/strutil.h \
    $(SRC_DIR)/ortools/lp_data/lp_print_utils.h \
    $(SRC_DIR)/ortools/lp_data/mps_reader.h | $(OBJ_DIR)/lp_data
...
$(OBJ_DIR)/lp_data/proto_utils.$O: \
    ...
    $(SRC_DIR)/ortools/lp_data/proto_utils.h | $(OBJ_DIR)/lp_data
...
$(OBJ_DIR)/lp_data/sparse.$O: \
    ...
    $(SRC_DIR)/ortools/base/join.h \
    $(SRC_DIR)/ortools/base/stringprintf.h \
    $(SRC_DIR)/ortools/lp_data/sparse.h | $(OBJ_DIR)/lp_data
...
$(OBJ_DIR)/lp_data/sparse_column.$O: \
    ...
    $(SRC_DIR)/ortools/base/stringprintf.h \
    $(SRC_DIR)/ortools/lp_data/lp_types.h \
    $(SRC_DIR)/ortools/lp_data/sparse_column.h | $(OBJ_DIR)/lp_data
...
$(OBJ_DIR)/glop/basis_representation.$O: \
    ...
    $(SRC_DIR)/ortools/glop/basis_representation.h \
    $(SRC_DIR)/ortools/glop/status.h \
    $(SRC_DIR)/ortools/lp_data/lp_utils.h | $(OBJ_DIR)/glop
...
$(OBJ_DIR)/glop/entering_variable.$O: \
    ...
    $(SRC_DIR)/ortools/glop/entering_variable.h \
    $(SRC_DIR)/ortools/lp_data/lp_utils.h \
    $(SRC_DIR)/ortools/port/proto_utils.h | $(OBJ_DIR)/glop
...
$(OBJ_DIR)/glop/lp_solver.$O: \
    ...
    $(SRC_DIR)/ortools/lp_data/proto_utils.h \
    $(SRC_DIR)/ortools/util/file_util.h \
    $(SRC_DIR)/ortools/util/fp_utils.h | $(OBJ_DIR)/glop
...
$(OBJ_DIR)/glop/preprocessor.$O: \
    ...
    $(SRC_DIR)/ortools/lp_data/lp_data_utils.h \
    $(SRC_DIR)/ortools/lp_data/lp_utils.h \
    $(SRC_DIR)/ortools/lp_data/matrix_utils.h | $(OBJ_DIR)/glop
...
$(OBJ_DIR)/glop/status.$O: \
    ...
    $(SRC_DIR)/ortools/base/logging.h \
    $(SRC_DIR)/ortools/glop/status.h | $(OBJ_DIR)/glop
...
$(OBJ_DIR)/glop/variables_info.$O: \
    ...
    $(SRC_DIR)/ortools/glop/variables_info.h | $(OBJ_DIR)/glop
...
$(GEN_DIR)/ortools/glop/parameters.pb.cc: \
	...
	$(PROTOC) --proto_path=$(INC_DIR) $(PROTOBUF_PROTOC_INC) --cpp_out=$(GEN_DIR) $(SRC_DIR)/ortools/glop/parameters.proto

$(GEN_DIR)/ortools/glop/parameters.pb.h: $(GEN_DIR)/ortools/glop/parameters.pb.cc \

$(OBJ_DIR)/glop/parameters.pb.$O:	$(GEN_DIR)/ortools/glop/parameters.pb.cc | $(OBJ_DIR)/glop
...
$(OBJ_DIR)/graph/assignment.$O: \
    ...
    $(SRC_DIR)/ortools/graph/assignment.h \
    $(SRC_DIR)/ortools/graph/ebert_graph.h \
    $(SRC_DIR)/ortools/graph/linear_assignment.h | $(OBJ_DIR)/graph
...
$(OBJ_DIR)/graph/astar.$O: \
    ...
    $(SRC_DIR)/ortools/base/adjustable_priority_queue.h \
    $(SRC_DIR)/ortools/base/callback.h \
    $(SRC_DIR)/ortools/base/integral_types.h | $(OBJ_DIR)/graph
...
$(OBJ_DIR)/graph/cliques.$O: \
    ...
    $(SRC_DIR)/ortools/base/hash.h \
    $(SRC_DIR)/ortools/graph/cliques.h | $(OBJ_DIR)/graph
...
$(OBJ_DIR)/graph/connected_components.$O: \
    ...
    $(SRC_DIR)/ortools/graph/connected_components.h | $(OBJ_DIR)/graph
...
$(OBJ_DIR)/graph/max_flow.$O: \
    ...
    $(SRC_DIR)/ortools/graph/graph.h \
    $(SRC_DIR)/ortools/graph/graphs.h \
    $(SRC_DIR)/ortools/graph/max_flow.h | $(OBJ_DIR)/graph
...
$(OBJ_DIR)/graph/min_cost_flow.$O: \
    ...
    $(SRC_DIR)/ortools/graph/graphs.h \
    $(SRC_DIR)/ortools/graph/max_flow.h \
    $(SRC_DIR)/ortools/graph/min_cost_flow.h | $(OBJ_DIR)/graph
...
$(OBJ_DIR)/graph/shortestpaths.$O: \
    ...
    $(SRC_DIR)/ortools/base/logging.h \
    $(SRC_DIR)/ortools/base/macros.h \
    $(SRC_DIR)/ortools/graph/shortestpaths.h | $(OBJ_DIR)/graph
...
$(OBJ_DIR)/graph/util.$O: \
    ...
    $(SRC_DIR)/ortools/graph/util.h | $(OBJ_DIR)/graph
...
$(GEN_DIR)/ortools/graph/flow_problem.pb.cc: \
	...
	$(PROTOC) --proto_path=$(INC_DIR) $(PROTOBUF_PROTOC_INC) --cpp_out=$(GEN_DIR) $(SRC_DIR)/ortools/graph/flow_problem.proto

$(GEN_DIR)/ortools/graph/flow_problem.pb.h: $(GEN_DIR)/ortools/graph/flow_problem.pb.cc \

$(OBJ_DIR)/graph/flow_problem.pb.$O:	$(GEN_DIR)/ortools/graph/flow_problem.pb.cc | $(OBJ_DIR)/graph
...
$(OBJ_DIR)/algorithms/dynamic_partition.$O: \
    ...
    $(SRC_DIR)/ortools/base/join.h \
    $(SRC_DIR)/ortools/base/murmur.h \
    $(SRC_DIR)/ortools/base/stringprintf.h | $(OBJ_DIR)/algorithms
...
$(OBJ_DIR)/algorithms/dynamic_permutation.$O: \
    ...
    $(SRC_DIR)/ortools/algorithms/dynamic_permutation.h \
    $(SRC_DIR)/ortools/algorithms/sparse_permutation.h | $(OBJ_DIR)/algorithms
...
$(OBJ_DIR)/algorithms/find_graph_symmetries.$O: \
    ...
    $(SRC_DIR)/ortools/base/time_support.h \
    $(SRC_DIR)/ortools/graph/iterators.h \
    $(SRC_DIR)/ortools/graph/util.h | $(OBJ_DIR)/algorithms
...
$(OBJ_DIR)/algorithms/hungarian.$O: \
    ...
    $(SRC_DIR)/ortools/algorithms/hungarian.h | $(OBJ_DIR)/algorithms
...
$(OBJ_DIR)/algorithms/knapsack_solver.$O: \
    ...
    $(SRC_DIR)/ortools/linear_solver/linear_solver.h \
    $(SRC_DIR)/ortools/util/bitset.h \
    $(SRC_DIR)/ortools/util/time_limit.h | $(OBJ_DIR)/algorithms
...
$(OBJ_DIR)/algorithms/sparse_permutation.$O: \
    ...
    $(SRC_DIR)/ortools/algorithms/sparse_permutation.h \
    $(SRC_DIR)/ortools/base/join.h \
    $(SRC_DIR)/ortools/base/logging.h | $(OBJ_DIR)/algorithms
...
$(OBJ_DIR)/sat/all_different.$O: \
    ...
    $(SRC_DIR)/ortools/sat/all_different.h \
    $(SRC_DIR)/ortools/sat/sat_solver.h \
    $(SRC_DIR)/ortools/util/sort.h | $(OBJ_DIR)/sat
...
$(OBJ_DIR)/sat/circuit.$O: \
    ...
    $(SRC_DIR)/ortools/base/map_util.h \
    $(SRC_DIR)/ortools/sat/circuit.h \
    $(SRC_DIR)/ortools/sat/sat_solver.h | $(OBJ_DIR)/sat
...
$(OBJ_DIR)/sat/clause.$O: \
    ...
    $(SRC_DIR)/ortools/base/logging.h \
    $(SRC_DIR)/ortools/base/stl_util.h \
    $(SRC_DIR)/ortools/sat/clause.h | $(OBJ_DIR)/sat
...
$(OBJ_DIR)/sat/cp_model_checker.$O: \
    ...
    $(SRC_DIR)/ortools/sat/cp_model_utils.h \
    $(SRC_DIR)/ortools/util/saturated_arithmetic.h \
    $(SRC_DIR)/ortools/util/sorted_interval_list.h | $(OBJ_DIR)/sat
...
$(OBJ_DIR)/sat/cp_model_expand.$O: \
    ...
    $(GEN_DIR)/ortools/sat/cp_model.pb.h \
    $(SRC_DIR)/ortools/sat/cp_model_utils.h \
    $(SRC_DIR)/ortools/util/saturated_arithmetic.h | $(OBJ_DIR)/sat
...
$(OBJ_DIR)/sat/cp_model_lns.$O: \
    ...
    $(SRC_DIR)/ortools/sat/cp_model_lns.h \
    $(SRC_DIR)/ortools/sat/cp_model_utils.h \
    $(SRC_DIR)/ortools/util/random_engine.h | $(OBJ_DIR)/sat
...
$(OBJ_DIR)/sat/cp_model_objective.$O: \
    ...
    $(SRC_DIR)/ortools/sat/cp_model_objective.h \
    $(SRC_DIR)/ortools/sat/cp_model_utils.h | $(OBJ_DIR)/sat
...
$(OBJ_DIR)/sat/cp_model_search.$O: \
    ...
    $(SRC_DIR)/ortools/sat/cp_model_search.h \
    $(SRC_DIR)/ortools/sat/cp_model_utils.h \
    $(SRC_DIR)/ortools/sat/util.h | $(OBJ_DIR)/sat
...
$(OBJ_DIR)/sat/cp_model_solver.$O: \
    ...
    $(SRC_DIR)/ortools/util/saturated_arithmetic.h \
    $(SRC_DIR)/ortools/util/sorted_interval_list.h \
    $(SRC_DIR)/ortools/util/time_limit.h | $(OBJ_DIR)/sat
...
$(OBJ_DIR)/sat/cumulative.$O: \
    ...
    $(SRC_DIR)/ortools/sat/sat_solver.h \
    $(SRC_DIR)/ortools/sat/timetable_edgefinding.h \
    $(SRC_DIR)/ortools/sat/timetable.h | $(OBJ_DIR)/sat
...
$(OBJ_DIR)/sat/drat_proof_handler.$O: \
    ...
    $(SRC_DIR)/ortools/base/logging.h \
    $(SRC_DIR)/ortools/base/memory.h \
    $(SRC_DIR)/ortools/sat/drat_proof_handler.h | $(OBJ_DIR)/sat
...
$(OBJ_DIR)/sat/drat_writer.$O: \
    ...
    $(SRC_DIR)/ortools/base/status.h \
    $(SRC_DIR)/ortools/base/stringprintf.h \
    $(SRC_DIR)/ortools/sat/drat_writer.h | $(OBJ_DIR)/sat
...
$(OBJ_DIR)/sat/linear_programming_constraint.$O: \
    ...
    $(SRC_DIR)/ortools/glop/status.h \
    $(SRC_DIR)/ortools/graph/strongly_connected_components.h \
    $(SRC_DIR)/ortools/sat/linear_programming_constraint.h | $(OBJ_DIR)/sat
...
$(OBJ_DIR)/sat/linear_relaxation.$O: \
    ...
    $(SRC_DIR)/ortools/base/iterator_adaptors.h \
    $(SRC_DIR)/ortools/sat/linear_relaxation.h | $(OBJ_DIR)/sat
...
$(OBJ_DIR)/sat/lp_utils.$O: \
    ...
    $(SRC_DIR)/ortools/sat/lp_utils.h \
    $(SRC_DIR)/ortools/sat/sat_base.h \
    $(SRC_DIR)/ortools/util/fp_utils.h | $(OBJ_DIR)/sat
...
$(OBJ_DIR)/sat/precedences.$O: \
    ...
    $(SRC_DIR)/ortools/base/stl_util.h \
    $(SRC_DIR)/ortools/sat/cp_constraints.h \
    $(SRC_DIR)/ortools/sat/precedences.h | $(OBJ_DIR)/sat
...
$(OBJ_DIR)/sat/restart.$O: \
    ...
    $(SRC_DIR)/ortools/base/split.h \
    $(SRC_DIR)/ortools/base/stringprintf.h \
    $(SRC_DIR)/ortools/sat/restart.h | $(OBJ_DIR)/sat
...
$(OBJ_DIR)/sat/symmetry.$O: \
    ...
    $(SRC_DIR)/ortools/base/int_type.h \
    $(SRC_DIR)/ortools/base/logging.h \
    $(SRC_DIR)/ortools/sat/symmetry.h | $(OBJ_DIR)/sat
...
$(OBJ_DIR)/sat/theta_tree.$O: \
    ...
    $(SRC_DIR)/ortools/base/int_type.h \
    $(SRC_DIR)/ortools/sat/theta_tree.h | $(OBJ_DIR)/sat
...
$(GEN_DIR)/ortools/sat/boolean_problem.pb.cc: \
	...
	$(PROTOC) --proto_path=$(INC_DIR) $(PROTOBUF_PROTOC_INC) --cpp_out=$(GEN_DIR) $(SRC_DIR)/ortools/sat/boolean_problem.proto

$(GEN_DIR)/ortools/sat/boolean_problem.pb.h: $(GEN_DIR)/ortools/sat/boolean_problem.pb.cc \

$(OBJ_DIR)/sat/boolean_problem.pb.$O:	$(GEN_DIR)/ortools/sat/boolean_problem.pb.cc | $(OBJ_DIR)/sat
...
$(GEN_DIR)/ortools/sat/cp_model.pb.cc: \
	...
	$(PROTOC) --proto_path=$(INC_DIR) $(PROTOBUF_PROTOC_INC) --cpp_out=$(GEN_DIR) $(SRC_DIR)/ortools/sat/cp_model.proto

$(GEN_DIR)/ortools/sat/cp_model.pb.h: $(GEN_DIR)/ortools/sat/cp_model.pb.cc \

$(OBJ_DIR)/sat/cp_model.pb.$O:	$(GEN_DIR)/ortools/sat/cp_model.pb.cc | $(OBJ_DIR)/sat
...
$(GEN_DIR)/ortools/sat/sat_parameters.pb.cc: \
	...
	$(PROTOC) --proto_path=$(INC_DIR) $(PROTOBUF_PROTOC_INC) --cpp_out=$(GEN_DIR) $(SRC_DIR)/ortools/sat/sat_parameters.proto

$(GEN_DIR)/ortools/sat/sat_parameters.pb.h: $(GEN_DIR)/ortools/sat/sat_parameters.pb.cc \

$(OBJ_DIR)/sat/sat_parameters.pb.$O:	$(GEN_DIR)/ortools/sat/sat_parameters.pb.cc | $(OBJ_DIR)/sat
...
$(OBJ_DIR)/bop/bop_base.$O: \
    ...
    $(SRC_DIR)/ortools/base/mutex.h \
    $(SRC_DIR)/ortools/bop/bop_base.h \
    $(SRC_DIR)/ortools/sat/boolean_problem.h | $(OBJ_DIR)/bop
...
$(OBJ_DIR)/bop/bop_fs.$O: \
    ...
    $(SRC_DIR)/ortools/sat/symmetry.h \
    $(SRC_DIR)/ortools/sat/util.h \
    $(SRC_DIR)/ortools/util/bitset.h | $(OBJ_DIR)/bop
...
$(OBJ_DIR)/bop/bop_portfolio.$O: \
    ...
    $(SRC_DIR)/ortools/bop/complete_optimizer.h \
    $(SRC_DIR)/ortools/sat/boolean_problem.h \
    $(SRC_DIR)/ortools/sat/symmetry.h | $(OBJ_DIR)/bop
...
$(OBJ_DIR)/bop/bop_solution.$O: \
    ...
    $(SRC_DIR)/ortools/bop/bop_solution.h | $(OBJ_DIR)/bop
...
$(OBJ_DIR)/bop/bop_util.$O: \
    ...
    $(SRC_DIR)/ortools/bop/bop_util.h \
    $(SRC_DIR)/ortools/sat/boolean_problem.h \
    $(SRC_DIR)/ortools/sat/sat_solver.h | $(OBJ_DIR)/bop
...
$(OBJ_DIR)/bop/complete_optimizer.$O: \
    ...
    $(SRC_DIR)/ortools/bop/complete_optimizer.h \
    $(SRC_DIR)/ortools/sat/boolean_problem.h \
    $(SRC_DIR)/ortools/sat/optimization.h | $(OBJ_DIR)/bop
...
$(OBJ_DIR)/bop/integral_solver.$O: \
    ...
    $(SRC_DIR)/ortools/bop/bop_solver.h \
    $(SRC_DIR)/ortools/bop/integral_solver.h \
    $(SRC_DIR)/ortools/lp_data/lp_decomposer.h | $(OBJ_DIR)/bop
...
$(GEN_DIR)/ortools/bop/bop_parameters.pb.cc: \
	...
	$(PROTOC) --proto_path=$(INC_DIR) $(PROTOBUF_PROTOC_INC) --cpp_out=$(GEN_DIR) $(SRC_DIR)/ortools/bop/bop_parameters.proto

$(GEN_DIR)/ortools/bop/bop_parameters.pb.h: $(GEN_DIR)/ortools/bop/bop_parameters.pb.cc \

$(OBJ_DIR)/bop/bop_parameters.pb.$O:	$(GEN_DIR)/ortools/bop/bop_parameters.pb.cc | $(OBJ_DIR)/bop
...
$(OBJ_DIR)/linear_solver/bop_interface.$O: \
    ...
    $(GEN_DIR)/ortools/bop/bop_parameters.pb.h \
    $(SRC_DIR)/ortools/bop/integral_solver.h \
    $(SRC_DIR)/ortools/linear_solver/linear_solver.h | $(OBJ_DIR)/linear_solver
...
$(OBJ_DIR)/linear_solver/glop_interface.$O: \
    ...
    $(SRC_DIR)/ortools/lp_data/lp_types.h \
    $(SRC_DIR)/ortools/port/proto_utils.h \
    $(SRC_DIR)/ortools/util/time_limit.h | $(OBJ_DIR)/linear_solver
...
$(OBJ_DIR)/linear_solver/glop_utils.$O: \
    ...
    $(SRC_DIR)/ortools/linear_solver/glop_utils.h | $(OBJ_DIR)/linear_solver
...
$(OBJ_DIR)/linear_solver/linear_solver.$O: \
    ...
    $(SRC_DIR)/ortools/linear_solver/model_validator.h \
    $(SRC_DIR)/ortools/port/file.h \
    $(SRC_DIR)/ortools/util/fp_utils.h | $(OBJ_DIR)/linear_solver
...
$(GEN_DIR)/ortools/linear_solver/linear_solver.pb.cc: \
	...
	$(PROTOC) --proto_path=$(INC_DIR) $(PROTOBUF_PROTOC_INC) --cpp_out=$(GEN_DIR) $(SRC_DIR)/ortools/linear_solver/linear_solver.proto

$(GEN_DIR)/ortools/linear_solver/linear_solver.pb.h: $(GEN_DIR)/ortools/linear_solver/linear_solver.pb.cc \

$(OBJ_DIR)/linear_solver/linear_solver.pb.$O:	$(GEN_DIR)/ortools/linear_solver/linear_solver.pb.cc | $(OBJ_DIR)/linear_solver
...
$(OBJ_DIR)/constraint_solver/ac4_mdd_reset_table.$O: \
    ...
    $(SRC_DIR)/ortools/constraint_solver/constraint_solver.h \
    $(SRC_DIR)/ortools/constraint_solver/constraint_solveri.h \
    $(SRC_DIR)/ortools/util/vector_map.h | $(OBJ_DIR)/constraint_solver
...
$(OBJ_DIR)/constraint_solver/alldiff_cst.$O: \
    ...
    $(SRC_DIR)/ortools/constraint_solver/constraint_solver.h \
    $(SRC_DIR)/ortools/constraint_solver/constraint_solveri.h \
    $(SRC_DIR)/ortools/util/string_array.h | $(OBJ_DIR)/constraint_solver
...
$(OBJ_DIR)/constraint_solver/assignment.$O: \
    ...
    $(SRC_DIR)/ortools/constraint_solver/constraint_solver.h | $(OBJ_DIR)/constraint_solver
...
$(OBJ_DIR)/constraint_solver/collect_variables.$O: \
    ...
    $(SRC_DIR)/ortools/base/stl_util.h \
    $(SRC_DIR)/ortools/constraint_solver/constraint_solver.h \
    $(SRC_DIR)/ortools/constraint_solver/constraint_solveri.h | $(OBJ_DIR)/constraint_solver
...
$(OBJ_DIR)/constraint_solver/constraint_solver.$O: \
    ...
    $(SRC_DIR)/ortools/constraint_solver/constraint_solveri.h \
    $(GEN_DIR)/ortools/constraint_solver/model.pb.h \
    $(SRC_DIR)/ortools/util/tuple_set.h | $(OBJ_DIR)/constraint_solver
...
$(OBJ_DIR)/constraint_solver/demon_profiler.$O: \
    ...
    $(SRC_DIR)/ortools/constraint_solver/constraint_solver.h \
    $(SRC_DIR)/ortools/constraint_solver/constraint_solveri.h \
    $(GEN_DIR)/ortools/constraint_solver/demon_profiler.pb.h | $(OBJ_DIR)/constraint_solver
...
$(OBJ_DIR)/constraint_solver/expr_cst.$O: \
    ...
    $(SRC_DIR)/ortools/constraint_solver/constraint_solveri.h \
    $(SRC_DIR)/ortools/util/saturated_arithmetic.h \
    $(SRC_DIR)/ortools/util/sorted_interval_list.h | $(OBJ_DIR)/constraint_solver
...
$(OBJ_DIR)/constraint_solver/interval.$O: \
    ...
    $(SRC_DIR)/ortools/constraint_solver/constraint_solver.h \
    $(SRC_DIR)/ortools/constraint_solver/constraint_solveri.h \
    $(SRC_DIR)/ortools/util/saturated_arithmetic.h | $(OBJ_DIR)/constraint_solver
...
$(OBJ_DIR)/constraint_solver/routing_flags.$O: \
    ...
    $(SRC_DIR)/ortools/constraint_solver/constraint_solver.h \
    $(GEN_DIR)/ortools/constraint_solver/routing_enums.pb.h \
    $(SRC_DIR)/ortools/constraint_solver/routing_flags.h | $(OBJ_DIR)/constraint_solver
...
$(OBJ_DIR)/constraint_solver/routing_neighborhoods.$O: \
    ...
    $(SRC_DIR)/ortools/constraint_solver/routing_neighborhoods.h | $(OBJ_DIR)/constraint_solver
...
$(OBJ_DIR)/constraint_solver/sat_constraint.$O: \
    ...
    $(SRC_DIR)/ortools/constraint_solver/sat_constraint.h | $(OBJ_DIR)/constraint_solver
...
$(OBJ_DIR)/constraint_solver/tree_monitor.$O: \
    ...
    $(SRC_DIR)/ortools/base/stringprintf.h \
    $(SRC_DIR)/ortools/constraint_solver/constraint_solver.h \
    $(SRC_DIR)/ortools/util/xml_helper.h | $(OBJ_DIR)/constraint_solver
...
$(OBJ_DIR)/constraint_solver/utilities.$O: \
    ...
    $(SRC_DIR)/ortools/constraint_solver/constraint_solver.h \
    $(SRC_DIR)/ortools/constraint_solver/constraint_solveri.h \
    $(SRC_DIR)/ortools/util/bitset.h | $(OBJ_DIR)/constraint_solver
...
$(GEN_DIR)/ortools/constraint_solver/assignment.pb.cc: \
	...
	$(PROTOC) --proto_path=$(INC_DIR) $(PROTOBUF_PROTOC_INC) --cpp_out=$(GEN_DIR) $(SRC_DIR)/ortools/constraint_solver/assignment.proto

$(GEN_DIR)/ortools/constraint_solver/assignment.pb.h: $(GEN_DIR)/ortools/constraint_solver/assignment.pb.cc \

$(OBJ_DIR)/constraint_solver/assignment.pb.$O:	$(GEN_DIR)/ortools/constraint_solver/assignment.pb.cc | $(OBJ_DIR)/constraint_solver
...
$(GEN_DIR)/ortools/constraint_solver/demon_profiler.pb.cc: \
	...
	$(PROTOC) --proto_path=$(INC_DIR) $(PROTOBUF_PROTOC_INC) --cpp_out=$(GEN_DIR) $(SRC_DIR)/ortools/constraint_solver/demon_profiler.proto

$(GEN_DIR)/ortools/constraint_solver/demon_profiler.pb.h: $(GEN_DIR)/ortools/constraint_solver/demon_profiler.pb.cc \

$(OBJ_DIR)/constraint_solver/demon_profiler.pb.$O:	$(GEN_DIR)/ortools/constraint_solver/demon_profiler.pb.cc | $(OBJ_DIR)/constraint_solver
...
$(GEN_DIR)/ortools/constraint_solver/model.pb.cc: \
	...
	$(PROTOC) --proto_path=$(INC_DIR) $(PROTOBUF_PROTOC_INC) --cpp_out=$(GEN_DIR) $(SRC_DIR)/ortools/constraint_solver/model.proto

$(GEN_DIR)/ortools/constraint_solver/model.pb.h: $(GEN_DIR)/ortools/constraint_solver/model.pb.cc \

$(OBJ_DIR)/constraint_solver/model.pb.$O:	$(GEN_DIR)/ortools/constraint_solver/model.pb.cc | $(OBJ_DIR)/constraint_solver
...
$(GEN_DIR)/ortools/constraint_solver/routing_enums.pb.cc: \
	...
	$(PROTOC) --proto_path=$(INC_DIR) $(PROTOBUF_PROTOC_INC) --cpp_out=$(GEN_DIR) $(SRC_DIR)/ortools/constraint_solver/routing_enums.proto

$(GEN_DIR)/ortools/constraint_solver/routing_enums.pb.h: $(GEN_DIR)/ortools/constraint_solver/routing_enums.pb.cc \

$(OBJ_DIR)/constraint_solver/routing_enums.pb.$O:	$(GEN_DIR)/ortools/constraint_solver/routing_enums.pb.cc | $(OBJ_DIR)/constraint_solver
...
$(GEN_DIR)/ortools/constraint_solver/routing_parameters.pb.cc: \
	...
	$(PROTOC) --proto_path=$(INC_DIR) $(PROTOBUF_PROTOC_INC) --cpp_out=$(GEN_DIR) $(SRC_DIR)/ortools/constraint_solver/routing_parameters.proto

$(GEN_DIR)/ortools/constraint_solver/routing_parameters.pb.h: $(GEN_DIR)/ortools/constraint_solver/routing_parameters.pb.cc \

$(OBJ_DIR)/constraint_solver/routing_parameters.pb.$O:	$(GEN_DIR)/ortools/constraint_solver/routing_parameters.pb.cc | $(OBJ_DIR)/constraint_solver
...
$(GEN_DIR)/ortools/constraint_solver/search_limit.pb.cc: \
	...
	$(PROTOC) --proto_path=$(INC_DIR) $(PROTOBUF_PROTOC_INC) --cpp_out=$(GEN_DIR) $(SRC_DIR)/ortools/constraint_solver/search_limit.proto

$(GEN_DIR)/ortools/constraint_solver/search_limit.pb.h: $(GEN_DIR)/ortools/constraint_solver/search_limit.pb.cc \

$(OBJ_DIR)/constraint_solver/search_limit.pb.$O:	$(GEN_DIR)/ortools/constraint_solver/search_limit.pb.cc | $(OBJ_DIR)/constraint_solver
...
$(GEN_DIR)/ortools/constraint_solver/solver_parameters.pb.cc: \
	...
	$(PROTOC) --proto_path=$(INC_DIR) $(PROTOBUF_PROTOC_INC) --cpp_out=$(GEN_DIR) $(SRC_DIR)/ortools/constraint_solver/solver_parameters.proto

$(GEN_DIR)/ortools/constraint_solver/solver_parameters.pb.h: $(GEN_DIR)/ortools/constraint_solver/solver_parameters.pb.cc \

$(OBJ_DIR)/constraint_solver/solver_parameters.pb.$O:	$(GEN_DIR)/ortools/constraint_solver/solver_parameters.pb.cc | $(OBJ_DIR)/constraint_solver
